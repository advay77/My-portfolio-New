...
export default function Portfolio() {
  ...
  useEffect(() => {
    ...
    skillCircles.forEach((circle) => {
      const originalDasharray = (circle as SVGElement).getAttribute("stroke-dasharray")
      ;(circle as SVGElement).setAttribute("stroke-dasharray", "0 251.2")
      setTimeout(() => {
        if (originalDasharray) {
          ;(circle as SVGElement).setAttribute("stroke-dasharray", originalDasharray)
        }
      }, 300)
    })
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-2 md:order-1 animate-on-scroll">
              ...
              <Button asChild className="bg-green-500 hover:bg-green-600 button-glow animate-on-scroll">
                ...
                {[
                  ...
                  >
                    ...
                    <div className="w-full bg-gray-700 rounded-full h-2">
                      <div
                        className="bg-green-500 h-2 rounded-full skill-progress-bar"
            ...
            <div className="animate-on-scroll" style={{ animationDelay: "300ms" }}>
              ...
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                {[
                  ...
                  >
                    <svg className="w-full h-32 circle-animation" viewBox="0 0 100 100">
          ...
          <div className="mt-10 md:mt-16 animate-on-scroll" style={{ animationDelay: "600ms" }}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-6">
              {[
                ...
                <div
                  key={tech}
                  className="bg-black/50 border border-green-500/30 rounded-lg p-4 text-center hover:border-green-500 transition-colors tech-card"
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
            {[
              ...
              <Card
                key={index}
                className="bg-black/50 border-green-500/30 overflow-hidden hover:border-green-500 transition-all group project-card"
                onMouseMove={handleTilt}
                onMouseLeave={handleTiltExit}
              >
